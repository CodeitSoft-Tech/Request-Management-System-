		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Laptop Users</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
	                	...
	                	<div class="clearfix">
						<h4 class="text-blue h4">Add Laptop User</h4>
					</div>
					<div class="wizard-content">
						<form action="add-laptop.php" method="post">
							...
							<section>
								...
								<div class="form-group">
									<button type="submit" name="lap-btn" class="btn btn-primary">Add User</button>
								</div>
