						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">View Desktop Users</li>
								</ol>
							</nav>
						</div>
			...
			<div class="modal" id="update<?php echo $user_id; ?>">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content modal-content-demo">
						...
						<form action="update-desktop.php" method="post">
							<section>
								<div class="row">
									<div class="col-md-6">
								...
								<div class="form-group">
								<button type="submit" name="desk-upbtn" class="btn btn-primary">Update Details</button>
								</div>
							</section>	
						</form>
					</div>
			...
			<div class="modal" id="delete<?php echo $user_id; ?>">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content modal-content-demo">
						...
						<div class="modal-body">
							<form action="desktop-del.php" method="post">
