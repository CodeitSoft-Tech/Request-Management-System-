					...
					<div class="wizard-content mt-5">
						<form action="member-request.php" method="post">
							<?php 
								...
								$get_name = "SELECT * FROM users_tbl WHERE fullname = '$username'";
								$run_name = mysqli_query($db, $get_name);
								$row_name = mysqli_fetch_array($run_name);
								$fullname = $row_name['fullname']; 
								$mine_no  = $row_name['mine_no'];
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" value="<?php echo $mine_no;  ?>" name="mine_number">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6">
										...
										<select class="form-control custom-select2" multiple="multiple" name="soft_comp[]">
											  ...
											  <option value="DeskWin Client">DeskWin Client (Mine Planning/Geology)</option>
												...
												<option value="Leica Geo-office">Leica Geooffice (Survey Software)</option>
											</optgroup>
