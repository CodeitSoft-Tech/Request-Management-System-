								...
								<div class="row clearfix">
									<div class="col-md-3 col-sm-12">
										<ul class="nav flex-column vtabs nav-tabs" role="tablist">
											<li class="nav-item">
												<a class="nav-link active" data-toggle="tab" href="#home3" role="tab" aria-selected="true">
												 Request Name
											  </a>
											</li>
											<li class="nav-item">
											...
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#contact3" role="tab" aria-selected="false">
												Department
											  </a>
											</li>
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#hod3" role="tab" aria-selected="false">
												HoD
											  </a>
											</li>
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#soft3" role="tab" aria-selected="false">
												Software Components
											  </a>
											</li>
											<li class="nav-item">
												<a class="nav-link" data-toggle="tab" href="#other3" role="tab" aria-selected="false">Other Requests</a>
											</li>
										</ul>
									</div>
									<div class="col-md-9 col-sm-12">
										<div class="tab-content">
											...
											<div class="tab-pane fade" id="hod3" role="tabpanel">
												<div class="pd-20">
													<?php echo $hod; ?>
												</div>
											</div>

											<div class="tab-pane fade" id="soft3" role="tabpanel">
												<div class="pd-20">
													<?php echo $soft; ?>
												</div>
											</div>

											<div class="tab-pane fade" id="other3" role="tabpanel">
												<div class="pd-20">
													<?php echo $other; ?>
												</div>
											</div>
