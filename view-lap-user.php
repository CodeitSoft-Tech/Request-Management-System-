...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>List of Laptop Users</title>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">View Laptop Users</li>
								</ol>
							</nav>
						</div>
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								...
								$lap_user = "SELECT * FROM laptop_users";
			...
			<div class="modal" id="update<?php echo $user_id; ?>">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content modal-content-demo">
						...
						<form action="update-laptop.php" method="post">
							<section>
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											...
											<input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
											<input type="text" class="form-control" value="<?php echo $m_type; ?>" name="m_type"> 
										</div>
								...
								<div class="form-group">
								 ...
								 <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
								 <input type="text" class="form-control" name="m_model" value="<?php echo $m_model; ?>">
								</div>
								...
								<div class="form-group">
								<button type="submit" name="lap-upbtn" class="btn btn-primary">Update Details</button>
								</div>
							</section>	
						</form>
					</div>
			...
			<div class="modal" id="delete<?php echo $user_id; ?>">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content modal-content-demo">
						...
						<div class="modal-body">
							<form action="view-lap-del.php" method="post">
