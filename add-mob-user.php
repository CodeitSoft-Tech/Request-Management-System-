		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
	                	...
	                	<div class="clearfix">
						<h4 class="text-blue h4">Add Mobile User</h4>
					</div>
					<div class="wizard-content">
						<form action="add-mobile.php" method="post">
							...
							<section>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="mob_brand">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
								 ...
								 <input type="text" class="form-control" name="mob_model">
								</div>
								...
								<div class="form-group">
									<button type="submit" name="mob-btn" class="btn btn-primary">Add User</button>
								</div>
