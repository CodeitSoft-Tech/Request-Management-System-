...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Registered Laptop Requests</title>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Registered Laptop Requests</li>
								</ol>
							</nav>
						</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Registration Details </h4>
					</div>
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							<thead>
								<tr>
									<th>Chasis Serial No</th>
									<th>Laptop Name</th>
									<th>Laptop Location</th>
									<th>System Name</th>
									<th>System Owner</th>
									<th>Admin By</th>
							...
							<tbody>
								...
								$lap_user = "SELECT * FROM registered_request WHERE system_role = 'Office Laptop'";
								$run_user  = mysqli_query($db, $lap_user);

								while($row = mysqli_fetch_array($run_user))
								{	
									$user_id        = $row['reg_req_id'];
									...
									$os_install     = $row['os_installed'];
									$admin_by       = $row['admin_by'];
									$emp_name       = $row['emp_name'];
									$position       = $row['position'];
									$req_date       = $row['date_taken'];
									$sec_group      = $row['security_groups'];
									$access_group   = $row['access_groups'];
									$purpose        = $row['purpose'];
									$add_doc        = $row['add_doc'];
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a href="print-laptop-request.php" class="dropdown-item" ><i class="dw dw-print"></i> Print </a>

												<a class="dropdown-item" data-target="#update<?php echo $user_id; ?>" data-toggle="modal" href="#update<?php echo $user_id; ?>"><i class="dw dw-eye"></i> View/Update</a>
